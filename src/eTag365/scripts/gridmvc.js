    ...
    */
    textFilterWidget.prototype.renderWidget = function () {
        var html = '<div class="form-group">\
                        <label class="control-label">' + this.lang.filterTypeLabel + '</label>\
                    ...
                    <div class="form-group">\
                        <label class="control-label">' + this.lang.filterValueLabel + '</label>\
...
DateTimeFilterWidget = (function ($) {
    ...
    dateTimeFilterWidget.prototype.renderWidget = function () {
        ...
        if (this.datePickerIncluded) {
            ...
            datePickerOptions.format = datePickerOptions.format || "yyyy-MMM-dd";
...
BooleanFilterWidget = (function ($) {
    ...
    booleanFilterWidget.prototype.renderWidget = function () {
        var html = '<label class="control-label">' + this.lang.filterValueLabel + '</label>\
                    <ul class="menu-list">\
