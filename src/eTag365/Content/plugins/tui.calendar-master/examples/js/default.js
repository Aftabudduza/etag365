...
(function(window, Calendar) {
    ...
    cal.on({
        ...
        'beforeCreateSchedule': function(e) {
            ...
            var URL = "/Pages/Resident/ManagementDashboard.aspx/" + "Save";
            var obj = {
                ...
                "TenantId": $('#txtTenantName').text(),
                "Title": e.title,
                "Description": e.location,
                "FromDate": new Date(e.start._date),
                "ToDate": new Date(e.end._date),
                "OwnerId": $('#ddlOwnerId option:selected').val()
            };
        ...
        'beforeUpdateSchedule': function(e) {
            ...
            var URL = "/Pages/Resident/ManagementDashboard.aspx/" + "Update";
            var obj = {
                "Id": e.schedule.calendarId,
                "PropertyManagerId": $('#ddlPropertyManagerId option:selected').val(),
                "LocationId": $('#ddlLocation option:selected').val(),
                "UnitId": $('#ddlUnitID option:selected').val(),
                "TenantId": $('#txtTenantName').text(),
                "Title": e.schedule.title,
                "Description": e.schedule.location,
                "FromDate": new Date(e.start._date),
                "ToDate": new Date(e.end._date),
                "OwnerId": $('#ddlOwnerId option:selected').val()
            };
        ...
        'beforeDeleteSchedule': function(e) {
            ...
            var URL = "/Pages/Resident/ManagementDashboard.aspx/" + "Delete";
            var obj = {
                "Id": e.schedule.calendarId
                //"PropertyManagerId": $('#ddlPropertyManagerId option:selected').val(),
                //"LocationId": $('#ddlLocation option:selected').val(),
                ...
                //"Title": e.schedule.title,
                //"Description": e.schedule.location,
                //"FromDate": new Date(e.schedule.start._date),
                //"ToDate": new Date(e.schedule.end._date),
                //"OwnerId": $('#ddlOwnerId option:selected').val()
            };
            let Basic = makeAjaxCallReturnPromiss(URL, obj);
            Basic.then((data) => {
    ...
    function setSchedules() {
        cal.clear();
        var URL = "/Pages/Resident/ManagementDashboard.aspx/" + "GetEventData";
        var obj = {
            "PropertyManagerId": $('#ddlPropertyManagerId option:selected').val(),
            "LocationId": $('#ddlLocation option:selected').val(),
            "UnitId": $('#ddlUnitID option:selected').val(),
            "TenantId": $('#txtTenantName').text(),
            "FromDate": new Date(cal.getDateRangeStart()),
            "ToDate": new Date(cal.getDateRangeEnd()),
            "OwnerId": $('#ddlOwnerId option:selected').val()
        };
        let Basic = makeAjaxCallReturnPromiss(URL, obj);
        Basic.then((data) => {
            if (data.d != null || data.d != "") {
                ...
                if (result.length > 0) {
                   // for (var i = 0; i < result.length; i++) {
                        generateSchedule(cal.getViewName(), cal.getDateRangeStart(), cal.getDateRangeEnd(), result);
