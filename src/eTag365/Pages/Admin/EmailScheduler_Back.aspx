<%@ Page Title="eTag365: Email Scheduler" Language="C#" MasterPageFile="~/MasterPage/Site.master" ValidateRequest="false" AutoEventWireup="true" Debug="true" CodeBehind="EmailScheduler_Back.aspx.cs" Inherits="eTag365.Pages.Admin.EmailSchedulerOld" %>
                ...
                <div class="box box-primary">
                    ...
                    <asp:UpdatePanel ID="upnlImageVideoUpld" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    <label for="ddlUser" class="col-sm-6 control-label">Person Name:</label>
                                    <div class="col-sm-6">
