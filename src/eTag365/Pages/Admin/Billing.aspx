<%@ Page Title="eTag365 Payment Options" Language="C#" AutoEventWireup="true" CodeBehind="Billing.aspx.cs" Inherits="eTag365.Pages.Admin.Billing" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <input type="hidden" id="hdYTDExportLimit" value="250" />
                                <input type="hidden" id="hdMTDImportLimit" value="10" />
                                <input type="hidden" id="hdStorageLimit" value="500" />
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-sm-3">
                                                $   <input type="text" disabled="disabled"  id="TotalAmountChargeRe" />
                                            </div>
                                        </div>
                            ...
                            <div class="box-footer">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 btnSubmitDiv">
                                        <input type="button" class="btn btn-success" id="btnSubmit2" style="background-color: #3B5998; float: left; margin-right: 20px;" value="Pay Now" />
                                        <input type="button" class="btn btn-success" id="btnSubmit3" style="background-color: #3B5998; float: left; margin-right: 20px;" value="Submit" />
